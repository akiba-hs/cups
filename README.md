...
6. Set queue defaults for `30 x 20 mm` labels with `2 mm` gaps:
   `docker compose exec cups lpadmin -p XPrinter-TDP245 -o PageSize=20x30mmRotated.Fullbleed -o PageRegion=20x30mmRotated.Fullbleed -o PaperType=1 -o Resolution=203dpi`
