...
To enable printer discovery on the network, add a service file such as `/etc/avahi/services/cups-printer.service` with the queue name adjusted to your printer:
```xml
